    ...
    return (
        <div className="w-full ">
            ...
            >
                ...
                />
                <h5 className="pl-2 block font-Poppins dark:text-white text-black min-w-0 truncate">
                    My Account
                </h5>
            </div>
            ...
            >
                <RiLockPasswordLine
                    size={20}
                    className="dark:text-white text-black shrink-0"
                />
                <h5 className="pl-2 block font-Poppins dark:text-white text-black min-w-0 truncate">
                    Change Password
                </h5>
            ...
            <div
                ...
                onClick={() => setActive(3)}
            >
                <SiCoursera size={20} className="dark:text-white text-black shrink-0" />
                <h5 className="pl-2 block font-Poppins dark:text-white text-black min-w-0 truncate">
                    Enrolled Courses
                </h5>
            </div>
            ...
            >
                <AiOutlineLogout size={20} className="dark:text-white text-black shrink-0" />
                <h5 className="pl-2 block font-Poppins dark:text-white text-black min-w-0 truncate">
                    Log Out
                </h5>
            </div>
